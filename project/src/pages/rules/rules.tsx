        ...
        <React.Fragment>
            ...
            <Main>
                <S.Wrapper>
                    ...
                    <S.Text>Индивидуальный предприниматель ТАРХАНЯН ГЕВОРК ШАВАРШОВИЧ, именуемый в дальнейшем Исполнитель, ОГРНИП: 322774600762101, ИНН: 772084229151, Дата присвоения ОГРНИП: 21.12.2022, использующий знак обслуживания «French With Emilie» адресует настоящие Правила любому лицу (неопределенному кругу лиц), чья воля будет выражена им лично либо через уполномоченного представителя (ст. 182, 185 Гражданского кодекса Российской Федерации), выразившему готовность принять предложение Исполнителя, на указанных ниже условиях. Настоящие Правила (далее по тексту – Правила) являются неотъемлемой частью Договора-оферты. Присоединение к Оферте обозначает согласие с настоящими Правилами. Присоединение к настоящим Правилам обозначает согласие к Договором-офертой.</S.Text>
                    ...
                    <S.Text>ИП Тарханян Геворк Шаваршович</S.Text>
